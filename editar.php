...
if (empty($dados['nome'])) {
    ...
    $retorna = ['status' => false, 'msg' => "<div class='alert alert-danger' role='alert'>Erro: Necessita preencher o campo nome!></div>"];

} elseif (empty($dados['email'])) {
    // Se o campo email estiver vazio, retorna mensagem de erro
    $retorna = ['status' => false, 'msg' => "<div class='alert alert-danger' role='alert'>Erro: Necessita preencher o campo e-mail!></div>"];
} elseif (empty($dados['logradouro'])) {
    // Se o campo logradouro estiver vazio, retorna mensagem de erro
    $retorna = ['status' => false, 'msg' => "<div class='alert alert-danger' role='alert'>Erro: Necessita preencher o campo logradouro!></div>"];
} elseif (empty($dados['numero'])) {
    // Se o campo numero estiver vazio, retorna mensagem de erro
    $retorna = ['status' => false, 'msg' => "<div class='alert alert-danger' role='alert'>Erro: Necessita preencher o campo número!></div>"];
    ...
    if ($edit_endereco->execute()) {
        ...
        $retorna = ['status' => false, 'msg' => "<div class='alert alert-danger' role='alert'>Erro: Usuário não ediatdo com sucesso!</div>"];
    }
} else {
    // Se a edição não foi bem sucedida
    $retorna = ['status' => false, 'msg' => "<div class='alert alert-danger' role='alert'>Erro: Usuário não ediatdo com sucesso!</div>"];
}
